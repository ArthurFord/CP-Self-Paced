...
====================
We've covered everything that you'll need to start building your own projects and begin a career in software development. Before you do anything though, make sure that you go through the next two days' interview bootcamp. Some concepts will be abstract and others will not. Let's get started.
