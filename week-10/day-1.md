Day 1
====================
* [Video](https://vimeo.com/324237258)
...
Next, move the contents of `wine_api` up one level so that your structure looks like this:
...
A completed copy of today's code can be found [here in this repo](https://github.com/codeplatoon/django-complete-wine-api).

## Challenges
* First, go over this tutorial yourself
* [Schools API](https://github.com/codeplatoon/school-api)
